...
+ 'dm,,,dm..,,,,,,,,,,,\n'
+ 'dm,,,dm..,,,,,,,,,,,\n'
+ 'dm,sessions,,statedm.sessions.state,,会话状态名,,,,sessions状态 idel active ,,,,,\n'
+ 'dm,sessions,,numdm.sessions.num,,会话数量,,,,,,,,,\n'
+ 'dm,basic,,instance_namedm.basic.instance_name,,实例名称,,,,,,,,,\n'
+ 'dm,basic,,portdm.basic.port,,端口,,,,,,,,,\n'
+ 'dm,basic,,system_pathdm.basic.system_path,,系统路径,,,,,,,,,\n'
+ 'dm,basic,,max_sessionsdm.basic.max_sessions,,最大会话数,,,,,,,,,\n'
+ 'dm,thread,dm_sql_thddm.thread.dm_sql_thd,,SQL线程数,,,,,,,,,\n'
+ 'dm,thread,dm_io_thddm.thread.dm_io_thd,,IO线程数,,,,,,,,,\n'
+ 'dm,thread,dm_tskwrk_thddm.thread.dm_tskwrk_thd,,任务线程数,,,,,,,,,\n'
+ 'dm,thread,dm_wrkgrp_thddm.thread.dm_wrkgrp_thd,,工作线程数,,,,,,,,,\n'
+ 'dm,instance,,namedm.instance.name,,实例名称,,,,,,,,,\n'
+ 'dm,instance,,host_namedm.instance.host_name,,主机名称,,,,,,,,,\n'
+ 'dm,instance,,db_versiondm.instance.db_version,,数据库版本,,,,,,,,,\n'
+ 'dm,instance,,svr_versiondm.instance.svr_version,,服务器版本,,,,,,,,,\n'
+ 'dm,instance,,statusdm.instance.status,,状态,,,,,,,,,\n'
+ 'dm,instance,,start_timedm.instance.start_time,,开始时间,,,,,,,,,\n'
+ 'dm,slow_sql,,ds_sess_iddm.slow_sql.ds_sess_id,,被阻塞的会话ID,,,,,,,,,\n'
+ 'dm,slow_sql,,ds_sql_textdm.slow_sql.ds_sql_text,,被阻塞的SQL,,,,,,,,,\n'
+ 'dm,slow_sql,,ds_trx_iddm.slow_sql.ds_trx_id,,被阻塞的事务ID,,,,,,,,,\n'
+ 'dm,slow_sql,,ltypedm.slow_sql.ltype,,锁类型,,,,,,,,,\n'
+ 'dm,slow_sql,,ds_create_timedm.slow_sql.ds_create_time,,开始阻塞时间,,,,,,,,,\n'
+ 'dm,slow_sql,,ss_sess_iddm.slow_sql.ss_sess_id,,占用锁的会话ID,,,,,,,,,\n'
+ 'dm,slow_sql,,ss_sql_textdm.slow_sql.ss_sql_text,,占用锁的SQL,,,,,,,,,\n'
+ 'dm,slow_sql,,ss_clnt_ipdm.slow_sql.ss_clnt_ip,,占用锁的客户端IP,,,,,,,,,\n'
+ 'dm,mem,,buffer_sizedm.mem.buffer_size,,系统缓冲区大小,,MB,,推荐值：系统缓冲区大小为可用物理内存的 60%～80%。有效值范围（8~1048576）,,,,,\n'
+ 'dm,mem,,mem_pooldm.mem.mem_pool,,共享内存池大小,,MB,,共享内存池是由 DM 管理的内存。有效值范围：32 位平台为（642000），64 位平台为（6467108864）,,,,,\n'
+ 'dm,buffer_pool,,namedm.buffer_pool.name,,缓冲池名称,,,,,,,,,\n'
+ 'dm,buffer_pool,,n_pagesdm.buffer_pool.n_pages,,缓冲池页数,,,,,,,,,\n'
+ 'dm,buffer_pool,,freedm.buffer_pool.free,,缓冲池空闲页数目,,,,"如果 free（缓冲区空闲页数目） 较大，说明该缓冲区空闲，可以适当的调整降低 buffer 缓冲区参数值。\n'
+ '如果 free 项为 0，或者 N_DISCARD64（淘汰页数） 非零，表示该缓冲区经常淘汰，说明对应的缓冲区参数太小，导致频繁淘汰，需要调整对应的缓冲区的参数。",,,,,\n'
+ 'dm,buffer_pool,,n_discard64dm.buffer_pool.n_discard64,,缓冲池淘汰页数,,,,如果 free 项为 0，或者 N_DISCARD64（淘汰页数） 非零，表示该缓冲区经常淘汰，说明对应的缓冲区参数太小，导致频繁淘汰，需要调整对应的缓冲区的参数。,,,,,\n'
+ 'dm,buffer_hit_ratio,,namedm.buffer_hit_ratio.name,,缓冲区名称,,,,,,,,,\n'
+ 'dm,buffer_hit_ratio,,sf_get_page_sizedm.buffer_hit_ratio.sf_get_page_size,,缓冲区大小,,,,,,,,,\n'
+ 'dm,buffer_hit_ratio,,rat_hitdm.buffer_hit_ratio.rat_hit,,缓冲区命中率,,,,"数据缓冲区是 DMSERVER 在将数据页写入磁盘之前以及从磁盘上读取数据页之后，数据页所存储的地方。\n'
+ '\n'
+ '数据缓冲区设定得太小，会导致缓冲页命中率低，磁盘 IO 频繁；将其设定得太大，又会导致操作系统内存本身不够用。",,,,,\n'
+ 'dm,tablespace,,namedm.tablespace.name,,表空间名称,,,,,,,,,\n'
+ 'dm,tablespace,,sizedm.tablespace.size,,表空间大小,,MB,,,,,,,\n'
+ 'dm,tablespace,,useddm.tablespace.used,,已使用空间,,MB,,,,,,,\n'
+ 'dm,tablespace,,usagedm.tablespace.usage,,表空间使用率,,%,,,,,,,\n'
+ 'dm,checkpoint,,last_begin_timedm.checkpoint.last_begin_time,,末次检查点开始时间,,,,,,,,,\n'
+ 'dm,checkpoint,,last_end_timedm.checkpoint.last_end_time,,末次检查点结束时间,,,,,,,,,\n'
+ 'dm,unsubmitted_trx_table,,object_namedm.unsubmitted_trx_table.object_name,,未提交事务的表名称,,,,有事务未提交的表名称。,,,,,\n'
+ 'dm,unsubmitted_trx_table,,sess_iddm.unsubmitted_trx_table.sess_id,,会话ID,,,,有事务未提交的会话ID。,,,,,\n'
+ 'dm,unsubmitted_trx_table,,trx_iddm.unsubmitted_trx_table.trx_id,,未提交事务ID,,,,,,,,,\n'
+ 'dm,max_mem_used_sql,,sessiddm.max_mem_used_sql.sessid,,会话ID,,,,,,,,,\n'
+ 'dm,max_mem_used_sql,,max_mem_useddm.max_mem_used_sql.max_mem_used,,最大使用内存,,,,"通过此 SQL 语句确定使用内存较大的 SQL，进行针对性的优化，如消除 HASH,SORT,DISTINCT 等操作。该查询只能查询当前活动 STMT 上的语句消耗情况，历史情况需要查询 V$SQL_STAT_HISTORY",,,,,\n'
+ 'dm,max_mem_used_sql,,sql_txtdm.max_mem_used_sql.sql_txt,,最多使用内存SQL,,,,,,,,,\n'
+ 'dm,max_phy_read_sql,,sessiddm.max_phy_read_sql.sessid,,会话ID,,,,,,,,,\n'
+ 'dm,max_phy_read_sql,,sql_txtdm.max_phy_read_sql.sql_txt,,最多物理读SQL,,,,,,,,,\n'
+ 'dm,max_phy_read_sql,,user_namedm.max_phy_read_sql.user_name,,用户名称,,,,,,,,,\n'
+ 'dm,max_phy_read_sql,,statedm.max_phy_read_sql.state,,状态,,,,,,,,,\n'
+ 'dm,max_phy_read_sql,,phy_read_cntdm.max_phy_read_sql.phy_read_cnt,,物理读次数,,,,,,,,,\n'
+ 'dm,max_phy_read_sql,,io_wait_timedm.max_phy_read_sql.io_wait_time,,IO等待时间,,,,,,,,,\n';
export default data;
