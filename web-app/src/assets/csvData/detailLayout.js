const data = 'mysql,基本信息,单指标,mysql.status.uptime,Single,,0,0,6,3,,,,5\n'
  ...
  + 'dm,基本信息,单指标dm.instance.name,Single,,0,0,6,3,,,,,,\n'
  + 'dm,基本信息,单指标dm.instance.host_name,Single,,0,6,6,3,,,,,,\n'
  + 'dm,基本信息,单指标dm.instance.db_version,Single,,0,12,6,3,,,,,,\n'
  + 'dm,基本信息,单指标dm.instance.svr_version,Single,,0,18,6,3,,,,,,\n'
  + 'dm,基本信息,单指标dm.instance.status,SingleGraph,,3,0,6,3,,,,,,\n'
  + 'dm,基本信息,单指标dm.instance.start_time,Single,,3,6,6,3,,,,,,\n'
  + 'dm,基本信息,单指标dm.checkpoint.last_begin_time,Single,,3,12,6,3,,,,,,\n'
  + 'dm,基本信息,单指标dm.checkpoint.last_end_time,Single,,3,18,6,3,,,,,,\n'
  + 'dm,基本信息,单指标dm.sessions.num,Graph,,6,0,12,8,,,,,,\n'
  + 'dm,基本信息,指标组合,cb.dm.thread_count,Graph,,6,12,12,8,,,,,,\n'
  + 'dm,基本信息,单指标,cb.dm.thread_count,Graph,,14,0,24,16,,,,,,\n'
  + 'dm,缓冲区,单指标dm.buffer_pool.n_pages,Graph,,0,0,12,8,,,,,,\n'
  + 'dm,缓冲区,单指标dm.buffer_pool.free,Graph,,0,12,12,8,,,,,,\n'
  + 'dm,缓冲区,单指标dm.buffer_pool.n_discard64,Graph,,8,0,12,8,,,,,,\n'
  + 'dm,缓冲区,单指标dm.buffer_hit_ratio.sf_get_page_size,Graph,,8,12,12,8,,,,,,\n'
  + 'dm,缓冲区,单指标dm.buffer_hit_ratio.rat_hit,Graph,,16,0,12,8,,,,,,\n'
  + 'dm,表空间,单指标dm.tablespace.name,TableView,,0,0,24,20,,,,,,\n'
  + 'dm,查询性能,单指标dm.slow_sql.ss_sql_text,TableView,,0,0,24,14,,,,,,\n'
  + 'dm,查询性能,单指标dm.unsubmitted_trx_table.trx_id,TableView,,14,0,24,14,,,,,,\n'
  + 'dm,查询性能,单指标dm.max_mem_used_sql.sql_txt,TableView,,28,0,24,14,,,,,,\n'
  + 'dm,查询性能,单指标dm.max_phy_read_sql.sql_txt,TableView,,42,0,24,14,,,,,,\n';
