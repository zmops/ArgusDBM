const data = 'mysql,基本信息,单指标,mysql.status.uptime,Single,,0,0,6,3,,,,5\n'
  ...
  + 'postgresql,基本信息,单指标,postgresql.status.uptime,Single,,0,0,6,3,,,,\n'
  + 'postgresql,基本信息,单指标,postgresql.basic.version,Single,,0,6,6,3,,,,\n'
  + 'postgresql,基本信息,单指标,postgresql.resource_config.shared_buffers,SingleGraph,,0,12,6,3,,,,\n'
  + 'postgresql,基本信息,单指标,postgresql.resource_config.work_mem,SingleGraph,,0,18,6,3,,,,\n'
  + 'postgresql,基本信息,单指标,postgresql.resource_config.autovacuum,SingleGraph,,3,0,6,3,,,,\n'
  + 'postgresql,基本信息,单指标,postgresql.resource_config.max_connections,SingleGraph,,3,6,6,3,,,,\n'
  ...
  + 'oracle,基本信息,单指标,oracle.mem_stats.num,Graph,,22,12,12,8,,,,\n'
  ...
  + 'dm,表空间,单指标,dm.tablespace.name,TableView,,0,0,24,18,,,,\n'
  + 'dm,查询性能,单指标,dm.slow_sql.ss_sql_text,TableView,,0,0,24,10,,,,\n'
  + 'dm,查询性能,单指标,dm.unsubmitted_trx_table.trx_id,TableView,,14,0,24,10,,,,\n'
  + 'dm,查询性能,单指标,dm.max_mem_used_sql.sql_txt,TableView,,28,0,24,10,,,,\n'
  + 'dm,查询性能,单指标,dm.max_phy_read_sql.sql_txt,TableView,,42,0,24,10,,,,\n'
