const data = 'mysql,基本信息,单指标,mysql.status.uptime,Single,,0,0,6,3,,,,5\n'
  ...
  + 'pgsql,基本信息,单指标,pgsql.resource_config.autovacuum,SingleGraph,,3,0,6,3,,,,\n'
  ...
  + 'pgsql,基本信息,指标组合,cb.pgsql.transactions,Graph,,6,12,12,8,,,,\n'
  + 'pgsql,基本信息,指标组合,cb.pgsql.tuples,Graph,,14,0,24,8,,,,\n'
  + 'pgsql,基本信息,单指标,pgsql.temp_file.num,Graph,,22,0,12,8,,,,\n'
  + 'pgsql,基本信息,单指标,pgsql.temp_file.size,Graph,,22,12,12,8,,,,\n'
  + 'pgsql,查询性能,单指标,pgsql.connection_state.num,Graph,堆叠,0,0,24,8,,,,\n'
  + 'pgsql,查询性能,指标组合,cb.pgsql.tuples,Graph,堆叠,8,0,24,8,,,,\n'
  + 'pgsql,查询性能,单指标,pgsql.cache_hit_ratio.ratio,Graph,,16,0,12,8,,,,\n'
  + 'pgsql,查询性能,指标组合,cb.pgsql.checkpoint_stats,Graph,,16,12,12,8,,,,\n'
  + 'pgsql,查询性能,指标组合,cb.pgsql.buffers,Graph,,24,0,24,8,,,,\n'
  + 'pgsql,查询性能,单指标,pgsql.slow_sql.sql_text,TableView,,32,0,24,8,,,,\n'
  + 'pgsql,锁与冲突,单指标,pgsql.lock.deadlocks,Graph,,0,0,12,8,,,,\n'
  + 'pgsql,锁与冲突,单指标,pgsql.lock.conflicts,Graph,,0,12,12,8,,,,\n'
  + 'pgsql,锁与冲突,单指标,pgsql.conflicts.bufferpin,Graph,,8,0,12,8,,,,\n'
  + 'pgsql,锁与冲突,单指标,pgsql.conflicts.deadlock,Graph,,8,12,12,8,,,,\n'
  + 'pgsql,锁与冲突,单指标,pgsql.conflicts.lock,Graph,,16,0,12,8,,,,\n'
  + 'pgsql,锁与冲突,单指标,pgsql.conflicts.snapshot,Graph,,16,12,12,8,,,,\n'
  + 'pgsql,锁与冲突,单指标,pgsql.conflicts.tablespace,Graph,,24,0,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.connection_db.active,Graph,,0,0,24,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.lock.deadlocks,Graph,,8,0,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.lock.conflicts,Graph,,8,12,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.cache_hit_ratio.ratio,Graph,,16,0,24,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.temp_file.num,Graph,,24,0,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.temp_file.size,Graph,,24,12,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.conflicts.bufferpin,Graph,,32,0,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.conflicts.deadlock,Graph,,32,12,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.conflicts.lock,Graph,,40,0,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.conflicts.snapshot,Graph,,40,12,12,8,,,,\n'
  + 'pgsql,库信息,单指标,pgsql.conflicts.tablespace,Graph,,48,0,12,8,,,,\n'
