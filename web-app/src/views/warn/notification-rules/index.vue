      ...
      <template v-slot:form>
        ...
        >
          <el-form-item :label="$t('notificationRules.form.name')" prop="name">
            <el-input v-model="form.name" :placeholder="$t('notificationRules.form[\'name.placeholder\']')" />
          </el-form-item>
          <el-form-item :label="$t('notificationRules.form.receiverName')" prop="receiverId">
            <el-select v-model="form.receiverId" :placeholder="$t('notificationRules.form[\'receiverName.placeholder\']')" style="width:100%" @change="handleReceiverChange">
          ...
          <el-form-item :label="$t('notificationRules.form.filterAll')">
            <el-switch v-model="form.filterAll" @change="handleSwitch" />
          </el-form-item>
          <el-form-item :label="$t('notificationRules.form.tags')">
            <el-select
              ...
              :placeholder="$t('notificationRules.form[\'tags.tip\']')"
              style="width:100%"
            >
          ...
          <el-form-item :label="$t('notificationRules.form.priorities')">
            <el-select
              ...
              :disabled="itemDisable"
              multiple
              :placeholder="$t('notificationRules.form[\'priorities.placeholder\']')"
              style="width:100%"
            >
          ...
          <el-form-item :label="$t('notificationRules.form.type')">
            <el-select v-model="form.type" multiple :placeholder="$t('notificationRules.form[\'type.placeholder\']')" style="width:100%">
              <el-option v-for="item in typeOptions" :key="item" :value="item">
                <el-option v-if="item==0" label="短信" :value="0" />
                <el-option v-if="item==1" label="邮件" :value="1" />
                <el-option v-if="item==4" label="企业微信" :value="4" />
                <el-option v-if="item==5" label="钉钉" :value="5" />
                <el-option v-if="item==2" label="WebHook" :value="2" />
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
  ...
  methods: {
    ...
    edit(id) {
      ...
      getRule(id).then(res => {
        ...
        this.itemDisable = this.form.filterAll == true
        this.$refs.dialogForm.handleDialogOpen()
      })
    },
    delete() {
