<template>
  <div>
    <div class="notice">
      <div class="notice-ac" >
        <div class="no-item" v-for="(item, index) in alarmNumList" :key="index">
          <el-tooltip :content="item.tooltip" placement="bottom" :offset="-10">
            <span>
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      alarmNumList: [
        // { severityName: '', num: 0, icon: 'disaster', id: 5,tooltip:'紧急' },
        // { severityName: '', num: 0, icon: 'critical', id: 4 ,tooltip:'高级'},
        { severityName: '', num: 0, icon: 'alarm', id: 3,tooltip:'紧急' },
        { severityName: '', num: 0, icon: 'ordinary', id: 2,tooltip:'严重' },
        { severityName: '', num: 0, icon: 'prompt', id: 1 ,tooltip:'警告'},
        // { severityName: '', num: 0, icon: 'event-un', id: 0,tooltip:'未定义' },
      ],
      noticeList: [],
      currentCount: 0,
      noticeLoading: false,
