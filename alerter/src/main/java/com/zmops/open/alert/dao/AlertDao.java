...
package com.zmops.open.alert.dao;

import com.zmops.open.alert.dto.AlertPriorityNum;
...
public interface AlertDao extends JpaRepository<Alert, Long>, JpaSpecificationExecutor<Alert> {
     ...
     */
    @Query("select new com.zmops.open.alert.dto.AlertPriorityNum(mo.priority, count(mo.id)) from Alert mo where mo.status = 0 group by mo.priority")
